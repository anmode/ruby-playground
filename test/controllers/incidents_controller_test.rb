...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference("Incident.count") do
      post incidents_url, params: { incident: { desc: @incident.desc, inc_id: @incident.inc_id, user_name: @incident.user_name } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { desc: @incident.desc, inc_id: @incident.inc_id, user_name: @incident.user_name } }
